...
class GraphQL::Breadth::HasBreadthResolverTest < Minitest::Test
  ...
  class LanguageFieldResolver < GraphQL::Breadth::FieldResolver
  ...
  class Widget < GraphQL::Schema::Object
    ...
    field :id, String, null: true do |field|
      field.breadth_resolver = GraphQL::Breadth::HashKeyResolver.new("id")
    end
  end
  ...
  class Query < GraphQL::Schema::Object
    ...
    field :widget, Widget, null: true do |field|
      field.breadth_resolver = GraphQL::Breadth::HashKeyResolver.new("widget")
    end
  ...
  def test_field_breadth_resolver_is_preferred_over_resolver_map
    resolvers = {
      "Query" => {
        "widget" => GraphQL::Breadth::ValueResolver.new({ "id" => "map" }),
      },
    }
  ...
  def test_directive_breadth_resolver_is_preferred_over_resolver_map
    resolvers = {
      "@inContext" => GraphQL::Breadth::ValueResolver.new("unused"),
    }
  ...
  def test_falls_back_to_resolver_map_without_field_breadth_resolver
    resolvers = {
      "Query" => {
        "fallback" => GraphQL::Breadth::ValueResolver.new("from-map"),
      },
    }
  ...
  def execute(schema, document, source, resolvers: GraphQL::Breadth::EMPTY_OBJECT)
