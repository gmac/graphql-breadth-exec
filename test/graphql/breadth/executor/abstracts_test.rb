...
class GraphQL::Breadth::Executor::AbstractsTest < Minitest::Test
  ...
  class TypeErrorQuery < GraphQL::Schema::Object
    ...
    field :node, TypeErrorNode, null: true do |field|
      field.breadth_resolver = GraphQL::Breadth::HashKeyResolver.new("node")
    end
  end
  ...
  def test_unresolved_abstract_type_reports_basic_schema_type_error
    ...
    assert_raises(GraphQL::Breadth::ImplementationError) { executor.result }
