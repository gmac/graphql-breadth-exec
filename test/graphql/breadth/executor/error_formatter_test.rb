...
class GraphQL::Breadth::Executor::ErrorFormatterTest < Minitest::Test
  TEST_RESOLVERS = {
    "Node" => {
    ...
    "Test" => {
      "id" => GraphQL::Breadth::HashKeyResolver.new("id"),
      "req" => GraphQL::Breadth::HashKeyResolver.new("req"),
      "opt" => GraphQL::Breadth::HashKeyResolver.new("opt"),
    },
    "Query" => {
      "node" => GraphQL::Breadth::HashKeyResolver.new("node"),
      "test" => GraphQL::Breadth::HashKeyResolver.new("test"),
      "reqField" => GraphQL::Breadth::HashKeyResolver.new("reqField"),
    },
  }.freeze
  ...
  def test_inline_errors_in_null_positions_report
    ...
    source = {
      "test" => [
        { "req" => "yes", "opt" => nil },
        { "req" => "yes", "opt" => GraphQL::Breadth::ExecutionError.new("Not okay!") },
      ],
    }
  ...
  def test_formats_errors_with_extensions
    ...
    source = {
      "test" => GraphQL::Breadth::ExecutionError.new("Not okay!", extensions: {
        "code" => "TEST",
        reason: "sorry",
      }),
    }
  ...
  def test_pushes_original_errors_into_context
    ...
    source = {
      "test" => GraphQL::Breadth::ExecutionError.new("Not okay!", cause: cause),
    }
