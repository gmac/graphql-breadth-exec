...
class GraphQL::BreadthExec::Incremental::ContextTest < Minitest::Test
  DeferredDelivery = GraphQL::BreadthExec::Incremental::DeferredDelivery
  DeferredExecutionScope = GraphQL::BreadthExec::Incremental::DeferredExecutionScope
  ExecutionScope = GraphQL::BreadthExec::Executor::ExecutionScope
  IncrementalContext = GraphQL::BreadthExec::Incremental::Context
