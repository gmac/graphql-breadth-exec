...
class GraphQL::BreadthExec::Executor::IntrospectionTest < Minitest::Test
  ...
  def execute_query(document, schema: TEST_SCHEMA)
    GraphQL::BreadthExec::Executor.new(schema, GraphQL.parse(document), resolvers: TEST_RESOLVERS, root_object: {}).result
  end
end
