...
class GraphQL::BreadthExec::Executor::IncrementalTest < Minitest::Test
  class BatchTrackingLoader < GraphQL::BreadthExec::LazyLoader
    class << self
  ...
  class LazyHashResolver < GraphQL::BreadthExec::FieldResolver
    def initialize(key)
      @key = key
    end
  ...
  def test_incremental_result_returns_normal_result_without_defer
    ...
    assert_instance_of GraphQL::BreadthExec::Incremental::Result, result
