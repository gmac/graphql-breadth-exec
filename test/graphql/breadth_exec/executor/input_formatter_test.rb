  ...
  module BreadthExec
    class Executor
      class InputFormatterTest < Minitest::Test
        UNDEFINED = GraphQL::BreadthExec::Executor::UNDEFINED
        ...
        def setup
          ...
          @input = GraphQL::BreadthExec::Executor::InputFormatter.new(@context)
          @state = GraphQL::BreadthExec::Executor::InputFormatter::State.new
        end
        ...
        def test_coerce_variable_values_non_input_type_raises_error
          ...
          error = assert_raises(GraphQL::BreadthExec::InputValidationErrorSet) do
        ...
        def test_coerce_argument_values_preserves_extensions_from_coerce_input_execution_error
          ...
          end #: as GraphQL::BreadthExec::InputValidationErrorSet
