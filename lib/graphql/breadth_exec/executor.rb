...
module GraphQL
  module BreadthExec
    class Executor
      ...
      def build_execution_field(exec_field, resolved_objects)
        ...
        if return_type.kind.composite?
          ...
          if return_type.kind.abstract?
            build_abstract_type_scopes(exec_field, return_type, next_objects, next_results)
          else
      ...
      def build_abstract_type_scopes(exec_field, return_type, next_objects, next_results)
